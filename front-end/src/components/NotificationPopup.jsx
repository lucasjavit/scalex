...
const NotificationPopup = ({ notification, onClose }) => {
  ...
  const getIcon = () => {
    switch (notification.type) {
      case 'success':
        return (
          <div className="flex-shrink-0 w-6 h-6 text-green-400">
      ...
      default:
        return (
          <div className="flex-shrink-0 w-6 h-6 text-blue-400">
            <svg fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div
      className={`
        relative max-w-sm w-full bg-copilot-bg-secondary border rounded-copilot-lg shadow-copilot-lg
        ${getBackgroundColor()}
        animate-slide-in-right
        transition-all duration-300 ease-out
        hover:shadow-copilot-xl
        group
      `}
      role="alert"
    >
            ...
            <div className="ml-4 flex-shrink-0 flex">
              <button
                className={`
                  ...
                  ${getTextColor()} hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20
                `}
